...
- Learn more about modifying biblio output across different formats. See solution notes https://stackoverflow.com/questions/48965247/use-csl-file-for-pdf-output-in-bookdown/49145699#49145699
...
- For final PDF and eBook build, create a "printbook" fork on GitHub, remove cover image and footers, and add code to index.Rmd below (BUT experiment with settings, especially for citation style)
```
output:
  bookdown::gitbook:
  ...
  ...
  bookdown::pdf_book:
    ...
    pandoc_args: [ "--csl", "chicago-fullnote-bibliography-no-ibid.csl" ]
