...
^[Jacob Solomon Goldberg (1891-1939) should not be confused with other Hartford residents with similar names. @JacobGoldbergObituary1939; @SecondAnniversaryCity1921; @KingswoodMarketHas1924; @connecticutstateboardofeducationSurveySchoolsWest1923, p. 103. ]

Goldberg looked for the perfect location to launch a second grocery store. He bought two parcels of undeveloped land on Farmington Avenue at the corner of Ardmore Avenue, on the trolley line that linked downtown Hartford to West Hartford's town center. Only a dozen small grocers served the entire town, and Goldberg's two closest competitors were about a half-mile way in each direction. While only 60 homes appeared on a 1923 Sanborn fire insurance map and the city directory listings of the immediate neighborhood, real estate developers and town officials had already divided up the land into property parcels in anticipation of future homebuyers. Next door to Goldberg's empty lot stood the only non-residential building in the area: the West Hartford Armory for the Connecticut National Guard Troop B Cavalry. The smell from its horse stables may have explained why no one had yet built a house on the adjacent empty lot now owned by Goldberg.^[@sanbornmapcompanySanbornFireInsurance1923; @GeerHartfordDirectory1922; @GeerHartfordDirectory1923; @rossanoBuiltServeConnecticut2003. The closest grocers in West Hartford were M.J. Burnham at 19 South Main Street and West Hill Grocery at 765 Farmington Avenue.]

INSERT MAP, past and present, with marker for Goldberg's land

But when Goldberg applied for a building permit, the Town of West Hartford refused him. Instead, the building inspector called for a public hearing on the issue in January 1923, where "a score of property owners in the Ardmore road section appeared and protested" against Goldberg's proposed grocery, which the *Hartford Courant* described would be located in "one of West Hartford's exclusive residential sections." Even though Goldberg had hired respected local architect William T. Marchant to design the store to conform with the town's building code, local officials and property owners challenged Goldberg's right to build a store in their neighborhood.[@LegalFightStore1923]

INSERT ABOVE -- describe more about size, 80 feet by 60 feet, two-story, but far smaller than the next-door Armory building with its horse stables.
...
## Anti-Semitism in Hartford Region, 1920s {- #anti-semitism}
