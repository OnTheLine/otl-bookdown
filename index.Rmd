...
**Read the web edition** at (http://ontheline.trincoll.edu) to fully experience the interactive maps, video clips, and source links. Any modern web browser will display the book, but readers may prefer larger screens (desktop, laptop, tablet) over smaller screens (such as smartphones). The web edition also displays these features near the top of the screen:
