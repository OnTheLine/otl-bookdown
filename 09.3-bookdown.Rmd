...
#### About PDF edition
The Bookdown-generated PDF edition is still a work-in-progress. Read more about various options at <https://bookdown.org/yihui/rmarkdown/pdf-document.html>. Currently using xelatex engine (see _bookdown.yml settings) to avoid unicode errors, but images are not ideal. 
