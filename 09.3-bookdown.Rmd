...
**TODO prior to PDF publication** Find LaTeX setting to convert "Figure" to "Image" in each caption in PDF. See <https://bookdown.org/yihui/bookdown/latexpdf.html> and <https://pandoc.org/MANUAL.html#variables-for-latex>.
