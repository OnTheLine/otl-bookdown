...
View the underlying source code to understand how this page was composed at: https://github.com/OnTheLine/otl-bookdown/blob/master/8.3.3-style-guide.Rmd.

The goal of this style guide is to compose one version of the text, primarily in easy-to-read R-flavored Markdown format, which Bookdown generates into multiple book products (HTML for open-access web edition, MS Word for editing, PDF for print edition, full-length Markdown for conversion, etc.).

This style guide was created primarily for the HTML web edition, and the PDF version will require additional modifications prior to final publication of the print edition.
