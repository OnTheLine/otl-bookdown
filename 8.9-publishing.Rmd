...
- For final PDF and eBook build, remove cover image and footers and add code to index.Rmd
```
config:
      toc:
...
- short reference code: `*by [Jack Dougherty](#contributors)*` with demo: *by [Jack Dougherty](#contributors)*
...
Insert line breaks with more carets **AND** type two spaces at end of each line:  
