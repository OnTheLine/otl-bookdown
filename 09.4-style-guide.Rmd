...
**KNOWN ISSUE in this book re: footnotes/endnotes**
...
- **KNOWN ISSUES TODO prior to final PDF edition**:
  - HTML edition labels images by sequential number across the entire book (1, 2, 3 etc.), while PDF edition labels images by chapter number (1.1, 1.2, 2.1, etc.).
