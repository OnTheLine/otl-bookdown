...
(ref:sample-local-pdf) Scroll the [sample PDF](images/bookdown/sample-local-pdf.pd) that is locally stored in the GitHub repo, with option to add Markdown link.
