...
View the underlying source code to understand how this page was composed at: https://github.com/ontheline/otl-bookdown/blob/main/8.3.4-images.Rmd
...
Write file names in lowercase with dashes (not spaces). Begin with the relevant year if possible, and keyword and/or source to match up with bibliographic information in Zotero.
