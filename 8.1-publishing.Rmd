...
To simplify long title references, insert a short ID name in curly brackets: `# Defining City and Suburban Lines {#defining}`
...
- problem: so far, no way to insert a short reference AND hide number, unless hiding numbers for all in settings
